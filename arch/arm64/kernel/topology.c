...
static struct idle_state idle_states_cluster_a53[] = {
	...
	{ .power = 17 }, /* WFI */
	{ .power = 17 }, /* cpu-sleep-0 */
	{ .power = 10 }, /* cluster-sleep-0 */
};

static struct idle_state idle_states_cluster_a72[] = {
	{ .power = 81 }, /* arch_cpu_idle() (active idle) = WFI */
	{ .power = 81 }, /* WFI */
	{ .power = 81 }, /* cpu-sleep-0 */
	{ .power = 69 }, /* cluster-sleep-0 */
};

static struct capacity_state cap_states_cluster_a53[] = {
        /* Power per cluster */
	{ .cap =  98, .power = 17, }, /*  480 MHz */
	{ .cap =  164, .power = 26, }, /*  807 MHz */
	{ .cap =  207, .power = 33, }, /*  1018 MHz */
	{ .cap =  266, .power = 52, }, /*  1306 MHz */
	{ .cap =  309, .power = 68, }, /*  1517 Mhz */
	{ .cap =  367, .power = 104, }, /*  1805 Mhz */
};

static struct capacity_state cap_states_cluster_a72[] = {
        /* Power per cluster */
	{ .cap =  195, .power = 82, }, /*  480 MHz */
	{ .cap =  328, .power = 90, }, /*  807 MHz */
	{ .cap =  492, .power = 101, }, /*  1210 MHz */
	{ .cap =  618, .power = 119, }, /*  1517 MHz */
	{ .cap =  735, .power = 155, }, /*  1805 MHz */
	{ .cap =  821, .power = 202, }, /*  2016 MHz */
	{ .cap =  938, .power = 282, }, /*  2304 MHz */
	{ .cap = 1024, .power = 295, }, /* 2516 MHz */
};
...
static struct idle_state idle_states_core_a53[] = {
	{ .power = 8 }, /* arch_cpu_idle() (active idle) = WFI */
	{ .power = 8 }, /* WFI */
	{ .power = 0 }, /* cpu-sleep-0 */
...
static struct idle_state idle_states_core_a72[] = {
	{ .power = 51 }, /* arch_cpu_idle() (active idle) = WFI */
	{ .power = 51 }, /* WFI */
	{ .power = 0  }, /* cpu-sleep-0 */
	{ .power = 0  }, /* cluster-sleep-0 */
};
...
static struct capacity_state cap_states_core_a53[] = {
        /* Power per cpu */
	{ .cap =  98, .power = 29, }, /*  480 MHz */
	{ .cap =  164, .power = 51, }, /*  807 MHz */
	{ .cap =  207, .power = 71, }, /*  1018 MHz */
	{ .cap =  266, .power = 124, }, /*  1306 MHz */
	{ .cap =  309, .power = 168, }, /*  1517 Mhz */
	{ .cap =  367, .power = 264, }, /*  1805 Mhz */
};

static struct capacity_state cap_states_core_a72[] = {
        /* Power per cpu */
	{ .cap =  195, .power = 195, }, /*  480 MHz */
	{ .cap =  328, .power = 286, }, /*  807 MHz */
	{ .cap =  492, .power = 398, }, /*  1210 MHz */
	{ .cap =  618, .power = 529, }, /*  1517 MHz */
	{ .cap =  735, .power = 766, }, /*  1805 MHz */
	{ .cap =  821, .power = 1052, }, /*  2016 MHz */
	{ .cap =  938, .power = 1609, }, /*  2304 MHz */
	{ .cap = 1024, .power = 1756, }, /* 2516 MHz */
};
