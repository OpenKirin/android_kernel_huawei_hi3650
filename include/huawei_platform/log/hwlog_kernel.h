...
#ifndef HWBDAT_pr
#define HWBDAT_pr(tag, fmt, ...) hwlog_to_write(HW_LOG_PRIO_DEBUG, HW_LOG_ID_BDAT, tag, fmt, ##__VA_ARGS__)
#endif

#ifndef HWBDAT_LOGV
#define HWBDAT_LOGV(tag, fmt, ...) hwlog_to_write(HW_LOG_PRIO_VERBOSE, HW_LOG_ID_BDAT, tag, fmt, ##__VA_ARGS__)
#endif

#ifndef HWBDAT_LOGD
#define HWBDAT_LOGD(tag, fmt,...) hwlog_to_write(HW_LOG_PRIO_DEBUG, HW_LOG_ID_BDAT, tag, fmt, ##__VA_ARGS__)
#endif

#ifndef HWBDAT_LOGI
#define HWBDAT_LOGI(tag, fmt, ...) hwlog_to_write(HW_LOG_PRIO_INFO,  HW_LOG_ID_BDAT, tag, fmt, ##__VA_ARGS__)
#endif

#ifndef HWBDAT_LOGW
#define HWBDAT_LOGW(tag, fmt, ...) hwlog_to_write(HW_LOG_PRIO_WARN,  HW_LOG_ID_BDAT, tag, fmt, ##__VA_ARGS__)
#endif

#ifndef HWBDAT_LOGE
#define HWBDAT_LOGE(tag, fmt, ...) hwlog_to_write(HW_LOG_PRIO_ERROR,  HW_LOG_ID_BDAT, tag, fmt, ##__VA_ARGS__)
#endif
