...
enum hw_device_type {
    ...
    DEV_CONNECTIVITY_WIFI = DEV_CONNECTIVITY_START, /* 37 */
    DEV_CONNECTIVITY_BT,                            /* 38 */
    DEV_CONNECTIVITY_FM,                            /* 39 */
    DEV_CONNECTIVITY_GPS,                           /* 40 */
    DEV_CONNECTIVITY_GPU,                           /* 41 */
    DEV_CONNECTIVITY_MAX,                           /* 42 */
};
