...
static hw_dec_struct hw_dec_device_array[] =
{
    ...
    { DEV_I2C_MAX,"NULL" },                     /* id : 36    order number 37 */
    { DEV_CONNECTIVITY_WIFI,"wifi" },           /* id : 37    order number 38 */
    { DEV_CONNECTIVITY_BT,"bt" },               /* id : 38    order number 39 */
    { DEV_CONNECTIVITY_FM,"fm" },               /* id : 39    order number 40 */
    { DEV_CONNECTIVITY_GPS,"gps" },             /* id : 40    order number 41 */
    { DEV_CONNECTIVITY_GPU,"gpu" },             /* id : 41    order number 42 */
};
