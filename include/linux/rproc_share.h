...
#define A7ISP_LOG_LEVEL_WATCHDOG    (1 << 28)
...
#define A7ISP_LOG_RESERVE_09        (1 << 9)
#define A7ISP_LOG_RESERVE_08        (1 << 8)
...
struct rproc_shared_para {
    ...
    unsigned int dynamic_pgtable_base;
};
