...
#define HISI_BL31_SIZE (0x200000)
...
#define HISI_BL31_RPMB_CRYPTOGRAPHIC_KEY_ADDR (HISI_BL31_PARAMS_FROM_FASTBOOT_PARAMS_ADDR + \
                 HISI_BL31_PARAMS_FROM_FASTBOOT_PARAMS_SIZE)
#define HISI_BL31_RPMB_CRYPTOGRAPHIC_KEY_SIZE (0x40)
...
#define HISI_BL31_MEM_RESERVE_SIZE (0x15FC70)
