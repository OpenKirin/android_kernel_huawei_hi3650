...
/*lint -e838 -e737 -e715 -e778 -e846 -e866 -e528 -e753 -e514 -e84 -e64*/
				 ...
				 char *buf)
{
	...
	ret += sprintf(buf+ret, "0x0:audio play; 0x1:audio record; 0x2:voice down; 0x3:voice up; 0x4:image load; 0x5:ec ref; 0x6:sound trigger; 0x7:debug; 0x8:hires play\n");
