...
enum SOCP_CODER_SRC_ENUM
{
    ...
    SOCP_CODER_SRC_LBBP3 = SOC_SOCP_CHAN_DEF(SOC_SOCP_CODER_SRC_CHAN,18),
    SOCP_CODER_SRC_LBBP4 = SOC_SOCP_CHAN_DEF(SOC_SOCP_CODER_SRC_CHAN,19),
    SOCP_CODER_SRC_LBBP5 = SOC_SOCP_CHAN_DEF(SOC_SOCP_CODER_SRC_CHAN,20),
    SOCP_CODER_SRC_LBBP6 = SOC_SOCP_CHAN_DEF(SOC_SOCP_CODER_SRC_CHAN,21),
    SOCP_CODER_SRC_LBBP7 = SOC_SOCP_CHAN_DEF(SOC_SOCP_CODER_SRC_CHAN,22),
    SOCP_CODER_SRC_LBBP8 = SOC_SOCP_CHAN_DEF(SOC_SOCP_CODER_SRC_CHAN,23),
