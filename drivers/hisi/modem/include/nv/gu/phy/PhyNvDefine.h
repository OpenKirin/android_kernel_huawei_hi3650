...
typedef struct
{
    ...
    VOS_UINT32                         uwGpioMask         :17;                  /* GPIO方式mask 寄存器配置*/
...
typedef struct
{
    ...
    VOS_UINT32                              uwHighPoweGpioValue;                /* 大功率时，输出线控 */
    VOS_UINT32                              uwHighPoweGpioMask;                 /* 大功率时，输出线控mask */
...
typedef struct
{
    VOS_UINT32                          uwReserve1:3;
    VOS_UINT32                          uwTestRxPart:1;                         /* RFIC1 Rx测试特性开关,1-打开,0-关闭，默认关闭 */
    VOS_UINT32                          uwRfResetOpen:1;                        /* RFIC 失锁复位功能特性开关,1-打开,0-关闭，默认关闭 */
    VOS_UINT32                          uwRfRecoveryOpen:1;                     /* RF Recovery关键寄存器恢复功能特性开关,1-打开,0-关闭，默认关闭 */
    VOS_UINT32                          uwRelAllOpen:1;                         /* Release All功能特性开关,1-打开,0-关闭，默认关闭 */
...
typedef struct
{
    ...
    VOS_UINT16                              uhwReserved;                        /* 保留字段 */
    VOS_UINT16                              uhwPclOptiThd;                      /* 通过路损调整上行发射功率方案的生效门限 */
