...
typedef struct
{
    ...
    VOS_UINT8                            ucDamFlag[2];                          /* DAM特性开关，1开启，0关闭，只是用ucDamFlag[0]位置 */
...
typedef struct
{
    PS_BOOL_ENUM_UINT8      ucConnPagingSwitch; /* 美国特性，连接态收paging特性开关 */
    VOS_UINT8               ucSwitch1;
    VOS_UINT8               ucSwitch2;
    ...
    VOS_INT16               sUSADeltaRsrp;          /* 美国特性，RSRP测量偏高，测量IND需要增加一个Delta值，默认值使用0 */
    VOS_UINT16              usPagingValidTime;      /* 美国特性，连接态不处理paging时延，默认为5s,范围为0-10s */
    VOS_UINT16              usRsv2;
    VOS_UINT16              usRsv3;
    VOS_UINT16              usRsv4;
    VOS_UINT16              usRsv5;
