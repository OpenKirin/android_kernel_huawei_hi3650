...
//    ID_VC_VOICE_SO_CTRL_SEND_SPECIAL_PACKETS = 0x9417,  /*VC不在conversation状态，需要声码器发特殊码流，该接口待与网侧交流后确定*/
    ID_VC_VOICE_SET_TTYMODE_IND = 0x9440,       /* 通话过程中通知VOICE新的TTY模式 */    /* _H2ASN_MsgChoice VCVOICE_SET_TTYMODE_IND_STRU */
...
/*****************************************************************************
 结构名    : VCVOICE_SET_TTYMODE_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 通话过程中VC通知VOICE新的TTY模式
*****************************************************************************/
typedef struct {
    VOS_MSG_HEADER
    VC_VOICE_MSG_ID_ENUM_UINT16     usMsgName;
    VOS_UINT16                      usReserved1;
    VCVOICE_WORK_TYPE_ENUM_UINT16   enWorkType;                                 /* TTY模式, 3: FULL 4: VCO 5: HCO*/
