...
/*****************************************************************************
 函 数 名  : dmac_pm_change_to_active_state
 功能描述  : data/唤醒的null帧发送完成切到active状态
 输入参数  : pst_pm_handler:对节能状态机结构体 pst_mac_hdr:mac头结构体
             pst_dmac_vap:dmac_vap结构体
 输出参数  : 无
 返 回 值  :
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : dmac_pm_sta_wait_for_mcast_callback
 功能描述  : 组播广播超时的定时器的超时函数
 输入参数  : void *p_arg
 输出参数  : 无
 返 回 值  :
 调用函数  :
...
/*****************************************************************************
 函 数 名  : dmac_pm_sta_wait_for_mcast
 功能描述  : 创建等待组播广播超时定时器
