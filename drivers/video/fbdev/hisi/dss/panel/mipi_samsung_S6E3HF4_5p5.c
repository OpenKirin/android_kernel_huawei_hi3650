...
static int mipi_samsung_s6e3hf4_set_brightness(struct platform_device *pdev, uint32_t bl_level)
{
	...
	if (hisifd->panel_info.bl_set_type & BL_SET_BY_PWM) {
		...
		g_brightness_value = last_bl_level;
	} else {
