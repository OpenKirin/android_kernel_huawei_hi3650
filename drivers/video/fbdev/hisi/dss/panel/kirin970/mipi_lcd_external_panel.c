...
static int mipi_jdi_probe(struct platform_device *pdev)
{
	...
	if (g_lcd_fpga_flag == 1) {
		//ldi
		pinfo->ldi.h_back_porch = 92; //23
		pinfo->ldi.h_front_porch = 200;//50
		pinfo->ldi.h_pulse_width = 80;//20
		pinfo->ldi.v_back_porch = 96;
		pinfo->ldi.v_front_porch = 112;
		pinfo->ldi.v_pulse_width = 32;

		//mipi
		pinfo->mipi.dsi_bit_clk = 130;
