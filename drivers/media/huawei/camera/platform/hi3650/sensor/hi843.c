...
static struct sensor_power_setting hi843_btv_power_setting[] = {
    //disable main camera reset
    {
        .seq_type = SENSOR_SUSPEND,
        .config_val = SENSOR_GPIO_LOW,
...
static sensor_t s_hi843_btv =
{
    .intf = { .vtbl = &s_hi843_vtbl, },
    .power_setting_array = {
            .size = ARRAY_SIZE(hi843_btv_power_setting),
            .power_setting = hi843_btv_power_setting,
     },
};
...
static const struct of_device_id s_hi843_dt_match[] =
{
    ...
    {
        .compatible = "huawei,hi843_btv",
        .data = &s_hi843_btv.intf,
    },
    {
    },
};
...
static int32_t hi843_platform_remove(struct platform_device* pdev);
static struct platform_driver s_hi843_driver =
{
    .probe = hi843_platform_probe,
    .remove = hi843_platform_remove,
    .driver =
    {
        .name = "huawei,hi843",
        .owner = THIS_MODULE,
