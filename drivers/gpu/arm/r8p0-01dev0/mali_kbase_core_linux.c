...
#if defined(CONFIG_MALI_PLATFORM_HI3650) || defined(CONFIG_MALI_PLATFORM_HI3660)
...
//#ifdef CONFIG_MALI_PLATFORM_HI3660
	...
	void __iomem *pmu_ssi1 = ioremap(0xfff36000, 0xfff);
	writel(0x00000001, pmu_ssi1+0x134);
	dev_err(kbdev->dev, "power on sequence 1.\n");
	msleep(5);
	writel(0x00010001, crg+0xf0);
	writel(0x00000038, crg+0x30);
	dev_err(kbdev->dev, "power on sequence 2.\n");
	msleep(1);
	writel(0x00000038, crg+0x34);
	writel(0x00010000, crg+0xf0);
	msleep(1);
	...
	writel(0x0000001c, crg+0x84);
	writel(0x0000001c, crg+0x88);
