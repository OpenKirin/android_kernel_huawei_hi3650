...
#define CSV_QUOTE  0x22		/*" */
	...
	struct csv_parser {
		...
		void *(*realloc_func) (const void *p, size_t new_size,
				       gfp_t flags);
...
/* Function Prototypes */
	...
	size_t csv_parse(struct csv_parser *p, const void *s, size_t len,
			 void (*cb1) (void *, size_t, void *), void (*cb2) (int,
									    void
									    *),
			 void *data);
...
/*int csv_fwrite2(FILE *fp, const void *src, size_t src_size, unsigned char quote);*/
	...
	void csv_set_realloc_func(struct csv_parser *p,
				  void *(*)(const void *, size_t, gfp_t));
