...
struct result {
	...
	int *cm_sensor_data;
	struct gd_sensor *gd_sensor_row_head;
	struct gd_sensor *gd_sensor_col_head;
	...
	int *cp_sensor_rx_calibration_gen6l;
	int *cp_sensor_tx_calibration_gen6l;
	int *cp_sensor_rx_delta_gen6l;
	int *cp_sensor_tx_delta_gen6l;
	int *cp_button_data;
...
extern int result_save(struct seq_file *file,
