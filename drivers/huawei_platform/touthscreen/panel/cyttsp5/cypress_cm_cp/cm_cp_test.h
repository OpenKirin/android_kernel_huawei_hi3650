...
#define MUTUAL_HW_BASELINE_CALIBRATION_DATA_ID  0x17
#define MUTUAL_HW_BASELINE_CALIBRATION_DATA_LENGTH  2

#define SELF_HW_BASELINE_CALIBRATION_DATA_ID  0x1D
...
extern int cm_cp_test_run_gen5(char *device_path, struct file *parameter_file,
		struct file *configuration_file, struct seq_file *result_file,
		int vdda, bool run_cm_test, bool run_cp_test,
		bool *cm_test_pass, bool *cp_test_pass);
